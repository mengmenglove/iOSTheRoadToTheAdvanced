...
@interface HBXTouchIDViewController ()

@end

@implementation HBXTouchIDViewController
...
- (void)buttonClick {
     ...
     */
    if (!data) {
        NSLog(@"设置evaluatedPolicyDomainState%@--",context.evaluatedPolicyDomainState);
